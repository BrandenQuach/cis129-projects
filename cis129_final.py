...
print(f'Answer for Question 10:')
list1 = [10,20,30]
list2 = [40,50]
concatenated_list = list1 + list2
print(concatenated_list)

print(f'Answer for Question 11:')
x = 'ABC'
x = '#'.join(x)
print(x)

print(f'Answer for Question 12:')
country_codes = {'Finland':'fi','South Africa':'za','Nepal':'np'}
for key in country_codes.keys():
    print(key)

print(f'Answer for Question 13:')
x = chr(66)
print(f'{x}')

print(f'Answer for Question 14:')
